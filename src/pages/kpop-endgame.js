    ...
    <div className="kpop">
        <section className="mw5 mw7-ns center bg-light-gray pa3 ph5-ns">
            ...
            <p className="lh-copy measure clickable">
                <img className="google" src="https://www.google.com/logos/fnbx/thanos/thanos_idle.png" alt="Google's Thanos infinity gauntlet"/>
                <p>Google's Thanos's Infinity Gauntlet</p>
            </p>
        </section>
